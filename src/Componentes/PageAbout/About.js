        ...
        <div id="about" className={styles.about}>
            ...
            <div className={styles.containerDescricao}>
                <div className={styles.descricaoleft}>
                    ...
                    <p className={styles.descricao}>Trabalho com uma variedade de linguagens, porém atualmente trabalho principal com React.js e Node.js, que me permitiu explorar a versatilidade da tecnologia. Meu projeto mais significativo até o momento é o WebApp My Feira, onde realizei o desenvolvimento do frontend com React e criei uma API no backend usando Node.js para se comunicar com o MongoDB. Adquiri até mesmo um domínio e hospedei a API na AWS.</p>
